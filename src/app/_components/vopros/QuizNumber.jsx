...
export default function QuizNumber({ q, value = 1, onChange }) {
    const max = q.max || 130; // можно задать максимум в вопросе или по умолчанию 100
    const min = q.min || 1;   // можно задать минимум в вопросе или по умолчанию 1
